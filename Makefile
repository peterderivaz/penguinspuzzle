...
OBJS=$(LEVELS) iceblock.o tree.o mainpeng.o babypeng.o bucket.o embed_file.o texmain24.o texsecond24.o water24.o clouds24.o woohoo.o boom.o wheee.o whooo.o cheers.o shot.o splosh.o penguinspuzzle.o buffer.o framebuffer.o keys.o matrix.o model.o penguins.o shaders.o texture.o view.o audio.o x11_display.o

BIN=penguinspuzzle.bin

CFLAGS=-std=gnu99

LDFLAGS+= -lX11 -lEGL -lGLESv2 -lm -lasound
